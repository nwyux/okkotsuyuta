  ...
  return (
    <div id="top" className="fullHome flex justify-center items-center">
      <div className="flex flex-col lg:flex-row justify-center items-center">
        ...
        <a href="#about" className="text-polaire text-sm rounded font-bold hover:underline py-2 px-2 bg-black border border-polaire">Discover me</a>
        <a href="#achievements" className="text-noir text-sm rounded font-bold hover:underline py-2 px-2 bg-polaire border border-polaire">My achievements</a>
        </div>
        </div>
      </div>
    </div>
